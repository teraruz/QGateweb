          ...
          <table id="example" class="display table" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th style="  border-bottom: 2px solid rgb(207 0 46); text-align: center;">Inspection Name</th>
                ...
                foreach ($tableInspection as $inspection) {
                  ...
                  echo "<td>
                                    <div class=\"text-wrap text-center\" >
                                     <button  class=\"d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm  me-md-2 \"  data-toggle=\"modal\" data-target=\"#editinspection\"  onclick='getDataInspection(" . $inspection["mit_id"] . ")'><i
