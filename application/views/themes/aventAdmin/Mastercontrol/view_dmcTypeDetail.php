                ...
                foreach ($tableDmcTypeDetail as $dmcdetail) {
                  ...
                  echo "<td>
                                    <div class=\"text-wrap text-center\" >
                                     <button  class=\"d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm  me-md-2 \"  data-toggle=\"modal\" data-target=\"#editDMCTypeDetail\"  onclick='getDataEditDMCTypeDetail(" . $dmcdetail["mdtd_id"] . ")'><i
