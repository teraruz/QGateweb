<div class="main-panel">
	<div class="content-wrapper">
		...
		<div class="row">
          ...
          <button type="button" class="btn btn-inverse-success btn-block" >Success</button>
					</div>
				</div>
			</div>
			<div class="col-xl-3 col-sm-6 grid-margin stretch-card">
          ...
          <button type="button" class="btn btn-inverse-primary btn-block" >Success</button>
					</div>
				</div>
			</div>
			<div class="col-xl-3 col-sm-6 grid-margin stretch-card">
			...
			<div class="col-md-4 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<canvas id="transaction-history" class="transaction-chart chartjs-render-monitor" style="display: block; height: 169px; width: 338px;" width="422" height="211"></canvas>
