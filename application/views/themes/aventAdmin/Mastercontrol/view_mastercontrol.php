                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-6 col-sm-11 col-xl-12 text-center ">
                                        <image src="<?php echo base_url() ?>assets/images/status.png"
                    ...
                    <div class="row">
                        <div class="col-sm-4 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-6 col-sm-11 col-xl-12 text-center ">
                                        <image src="<?php echo base_url() ?>assets/images/DMC.png"
                                            style="width=:50; height:50;">
                                        </image>
                                    </div>
                                    <a type="button" class="btn btn-inverse-danger btn-block"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-6 col-sm-11 col-xl-12 text-center ">
                                        <image src="<?php echo base_url() ?>assets/images/defect.png"
                                            style="width=:50; height:50;">
                                        </image>
                                    </div>
                                    <a type="button" class="btn btn-inverse-danger btn-block"
                    ...
                    <div class="row">
                        <div class="col-sm-4 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-6 col-sm-11 col-xl-12 text-center ">
                                        <image src="<?php echo base_url() ?>assets/images/zone.png"
                                            style="width=:50; height:50;">
                                        </image>
                                    </div>
                                    <a type="button" class="btn btn-inverse-danger btn-block"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-6 col-sm-11 col-xl-12 text-center ">
                                        <image src="<?php echo base_url() ?>assets/images/detail.png"
                                            style="width=:50; height:50;">
                                        </image>
                                    </div>
                                    <a type="button" class="btn btn-inverse-danger btn-block"
